...
#define DEFINE_CLASS_BEGIN( _class, ... ) \
	DEFINE_CLASS_BEGIN_IMPLEMENT( Gamma::eConstructType_Normal, _class, __VA_ARGS__)
...
#define DEFINE_UNDUPLICATABLE_CLASS_BEGIN( _class, ... ) \
	DEFINE_CLASS_BEGIN_IMPLEMENT( Gamma::eConstructType_Unduplicatable, _class, __VA_ARGS__)
...
#define DEFINE_ABSTRACT_CLASS_BEGIN( _class, ... ) \
	DEFINE_CLASS_BEGIN_IMPLEMENT( Gamma::eConstructType_Abstract, _class, __VA_ARGS__)
