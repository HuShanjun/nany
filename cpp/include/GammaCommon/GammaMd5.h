...
namespace Gamma 
{
	...
	class MD5
	{
		...
		#define MD5_BASE_F(x, y, z) (((x) & (y)) | ((~x) & (z)))
		#define MD5_BASE_G(x, y, z) (((x) & (z)) | ((y) & (~z)))
		#define MD5_BASE_H(x, y, z) ((x) ^ (y) ^ (z))
		#define MD5_BASE_I(x, y, z) ((y) ^ ((x) | (~z)))
	...
	public:
		static inline void MD5Init (MD5_CTX *);
	...
	inline void MD5::MD5Init (MD5_CTX *context)
	{
	...
	//context.
	inline void MD5::MD5Update (MD5_CTX *context, const unsigned char *input, unsigned int inputLen)
	{
	...
	inline void MD5::MD5Final (unsigned char digest[16], MD5_CTX *context)
	{
	...
	inline void MD5::MD5_memcpy (unsigned char* output, unsigned char* input, unsigned int len)
	{
		unsigned int i;
	...
	inline void MD5::MD5_memset (unsigned char* output, int value, unsigned int len)
	{
		unsigned int i;
	...
	inline void MD5( uint8_t szResult[16], const void* pData, size_t nSize )
	{
		MD5_CTX context;
		MD5::MD5Init( &context );
		MD5::MD5Update( &context, (const unsigned char*)pData, (unsigned int) nSize );
